...
<head>
    ...
    <style>
        ...
        /* Search input styles */
        #search {
            width: calc(100% - 38px); /* Adjusted width to accommodate the icon */
            padding: 10px;
            font-size: 16px;
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="browseblood.jsp" class="nav-item nav-link active">Search Blood Units</a>
...
<div class="container my-5">
   ...
   <%
       ...
       String query="SELECT * FROM donate WHERE mobile='"+mobile+"' && status='Available'";
       userRequestBlood obj=new userRequestBlood();
       ResultSet rs=obj.Retrieve(query);
       if(rs.next()){
       String q1="UPDATE donate SET status='Reserved' WHERE mobile='"+mobile+"'";
   ...
   %> 
    ...
    <div class="row">
        <div class="col-lg-12">
            <form  method="POST" id="myform" onsubmit="return validateuser()" action="sendEmailtoDonor.jsp" name="myform" class="bg-light p-5 contact-form">
...
<%
            ...
            request.getSession();
                ...
                response.sendRedirect("browseblood.jsp");
        }
   }else{
         request.getSession();
                session.setAttribute("failed", "Blood is Already Reserved");
                response.sendRedirect("browseblood.jsp");      
     }
%>
</div>
