    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Blood Details</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <div class="col-md-12 mx-auto mb-4">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h5 class="mb-0">Add Blood Details</h5>
                        </div>
                        <div class="card-body border border-dark p-5" style="box-shadow: 0px 10px 10px grey;">
            <form action="addbloodAction.jsp" method="POST" id="myform" onsubmit="return validateuser()"  name="myform" class="contactForm">
                                <!-- Row 1 -->
                                <div class="row mb-4">
                                    <!-- Full Name -->
                                    <div class="col">
