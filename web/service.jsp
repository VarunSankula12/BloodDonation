    ...
    <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">Blood Donation Services</h1>
                <p class="mb-5">Our project revolves around providing essential blood donation services, offering a range of critical tests and analyses to safeguard the blood supply.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Microbiological Safety</h4>
                            <p class="mb-4">Our microbiological tests are at the forefront of preserving the integrity of donated blood. We employ advanced techniques to identify .</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Biochemical Assessment</h4>
                            <p class="mb-4">Biochemistry tests are instrumental in evaluating the quality of donated blood. With meticulous examination of key biomarkers.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Blood Screening</h4>
                            <p class="mb-4">Blood tests are the backbone of our donation process. We utilize them to determine blood type, screen for infections, and assess donor health .</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Fever Investigations</h4>
                            <p class="mb-4">Our fever tests are indispensable for evaluating the health of potential blood donors, guaranteeing that donors are in optimal health.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
            </div>
