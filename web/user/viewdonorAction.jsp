...
<%
    ...
    String query="SELECT * FROM donatenow WHERE recepientmobile='"+mobile+"'";
...
%>                                
                                ...
                                <tr>
                                    ...
                                    <td><%=rs.getString("donorbloodgroup")%></td>
                                    <td><%=rs.getString("donormobile")%></td>
                                    <td><%=rs.getString("donorage")%></td>
                                    <td><%=rs.getString("donorlocation")%></td>
                                    <td><%= rs.getString("status")%></td>
                                    <td><a class="btn btn-sm btn-success" href="acceptDonor.jsp?rmobile=<%=mobile%>&dmobile=<%=rs.getString("donormobile")%>">Accept</a>
                                    </td>
                                </tr>
<%
    }
