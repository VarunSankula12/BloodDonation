...
<head>
    ...
    <style>
        /* Remove default table borders and use a light gray background */
        table {
        ...
        tr {
            ...
            border-bottom: 1px solid #e0e0e0; /* Add a subtle border between rows */
        }
        ...
        .container2 {
            background-image: url('img/bd1.jpg'); /* Replace with your image URL */
            background-size: cover;
            background-position: center;
            opacity: 0.8; /* Adjust opacity to your preference (0.0 to 1.0) */
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="user-dasboard.jsp" class="nav-item nav-link active">Dashboard</a>
                
                <a href="browseblood.jsp" class="nav-item nav-link">Search Blood Units</a>
                <a href="request.jsp" class="nav-item nav-link">Request Blood</a>
...
<div class="container container2">
    <div class="row col-md-12 col-md-offset-2 custyle">
        <h3 class="my-4">Available Donors</h3>
        <div class="alert alert-info text-dark" role="alert" style="font-weight: 900;">
            <div class="d-flex justify-content-between align-items-center">
                <marquee behavior="scroll" direction="left" scrollamount="13">
                    Note: Please remember to contact donors only when you need blood.
                </marquee>
        ...
        <table class="table table-striped custab mt-2">
            ...
            <tbody>
           <%
        int count=0;String val="Available";
        String query="SELECT * FROM donate WHERE status='"+val+"'";
...
%>                           
                        <tr>
                            ...
                            <td class="text-center">
                                <a class='btn btn-success btn-xs' href="contactDonor.jsp?name=<%=rs.getString("name")%>&email=<%=rs.getString("email")%>">Contact</a>
                            </td>
                        </tr>
<%
        }
