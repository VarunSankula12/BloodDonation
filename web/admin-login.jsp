            ...
            <div class="card card-default mb-0">
                <div class="card-header pb-0">
                    <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                        <h1 class=" m-0 p-3"><i class="fa fa-medkit" aria-hidden="true"></i> Blood<span class="" style="color: yellow">Care</h1>
                        
                    </div>
                </div>
                <div class="card-body px-5 pb-5 pt-0">
                    
                    <h2 class=" mb-6 text-center mt-3 text-primary">Admin Login</h2>
                    
                    <form action="adminloginAction.jsp" class="col-9 mx-auto mt-4" enctype="multipart/form-data">
                        <!-- {% csrf_token %} -->
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input type="text" class="form-control input-lg" id="email" aria-describedby=""
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-danger btn-pill mb-4 col-12">Login</button>
