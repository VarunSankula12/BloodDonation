...
<%
        String status="";int fulfilled=0;int pending=0;
        adminDao obj=new adminDao();
        String q2="SELECT * FROM requestblood";
        ResultSet rs=obj.Retrieve(q2);
        while(rs.next()){
            status=rs.getString("donoravailableforbloodreq");
                            ...
                            new Chart(document.querySelector('#barChart'), {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                        ...
                                        data: [<%=pending%>, <%=fulfilled%>], // Replace with your data for pending and fulfilled requests
                                        backgroundColor: [
