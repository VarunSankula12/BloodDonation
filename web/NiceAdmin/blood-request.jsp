...
<%
        int count=0;
        String query="SELECT * FROM requestblood";
...
%>                           
                        <tr>
                            ...
                            <td class="text-center">
                                <a class='btn  btn-xs btn-success' href="approveAction.jsp?mobile=<%=rs.getString("mobile")%>">Approve</a>
                                <a class='btn btn-danger btn-xs' href="rejectAction.jsp?mobile=<%=rs.getString("mobile")%>">Reject</a>
                            </td>
                        </tr>
<%
    }
